...
(function() {
  var YParser, anyfailed, assert, expected, grammar_cmd, grammar_id, grammar_line, grammar_str, parser, parser0, parser1, parser2, res, _assert;
  ...
  assert("parse main `" + parser0.buffer + "`", parser !== false);
